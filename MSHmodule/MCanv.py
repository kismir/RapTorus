    ...
    def __init__(self,cons,master):
        ...
        def draw(canvas):
            ...
            for vec in vect:
                ...
                vec_n=[]
                for v in vec[1:]:
                    vec_n.append(qm.rotAng((v[0]-cmass_x/csf,v[1]-cmass_y/csf,v[2]-cmass_z/csf),rot_axis,angl))
                ...
                z=[]
                for v in vec_n:
                    z.append((v[0]*cons.scale_factor,v[1]*cons.scale_factor,v[2]*cons.scale_factor))
